"""
Test file for User Journey UI BDD scenarios.

This test file uses pytest-bdd to execute scenarios from the
user_journey.feature file, providing comprehensive testing of
user journeys through the application using Playwright and Page Object Model.
"""
...
# Load all scenarios from the user_journey feature file
# Path is relative to the bdd_features_base_dir configured in pytest.ini
scenarios('ui/user_journey.feature')
