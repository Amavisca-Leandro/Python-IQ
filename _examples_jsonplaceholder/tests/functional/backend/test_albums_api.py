"""
Test file for Albums API BDD scenarios.

This test file uses pytest-bdd to execute scenarios from the
albums.feature file, providing comprehensive testing of the
JSONPlaceholder Albums API endpoints.
"""
...
# Load all scenarios from the albums feature file
# Path is relative to the bdd_features_base_dir configured in pytest.ini
scenarios('api/albums.feature')
