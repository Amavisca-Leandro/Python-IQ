"""
Test file for Users API BDD scenarios.

This test file uses pytest-bdd to execute scenarios from the
users.feature file, providing comprehensive testing of the
JSONPlaceholder Users API endpoints.
"""
...
# Load all scenarios from the users feature file
