"""
Test file for API Filtering BDD scenarios.

This test file uses pytest-bdd to execute scenarios from the
filters.feature file, providing comprehensive testing of the
JSONPlaceholder API filtering capabilities across all endpoints.
"""
...
# Load all scenarios from the filters feature file
# Path is relative to the bdd_features_base_dir configured in pytest.ini
scenarios('api/filters.feature')
